...
<tr id="tr_ms_domain">
<th><label for="ms_domain"><?php _e('Site Domain', 'frontend-user-admin') ?></label> <span class="required"><?php echo $required; ?></span></th>
<td<?php if( !empty($this->errors->errors['blogname'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="ms_domain" id="ms_domain" class="input frontend-user-admin-ms_domain" value="<?php if ( !empty($_POST['ms_domain']) ) echo esc_attr($_POST['ms_domain']); ?>"  /> <?php _e('Half-width alphamerics', 'frontend-user-admin') ?></td>
</tr>
<?php endif; ?>
<?php		break;
			case "ms_title": ?>
...
<tr id="tr_ms_title">
<th><label for="ms_title"><?php _e('Site Title', 'frontend-user-admin') ?></label> <span class="required"><?php echo $required; ?></span></th>
<td<?php if( !empty($this->errors->errors['blog_title'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="ms_title" id="ms_title" class="input frontend-user-admin-ms_title" value="<?php if ( !empty($_POST['ms_title']) ) echo esc_attr($_POST['ms_title']); ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "user_login": ?>
...
<tr>
<th><label for="user_login"><?php _e('Username', 'frontend-user-admin') ?></label> <span class="required"><?php echo $required; ?></span></th>
<td<?php if( !empty($this->errors->errors['user_login'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="user_login" id="user_login" class="input frontend-user-admin-user_login" value="<?php if ( isset($_POST['user_login']) ) echo esc_attr($_POST['user_login']); ?>" size="20" /> <?php _e('Half-width alphamerics', 'frontend-user-admin') ?></td>
</tr>
<?php endif; ?>
<?php		break;
			case "last_name": ?>
...
<tr>
<th><label for="last_name"><?php _e('Last name', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["register_last_name_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['last_name'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="last_name" id="last_name" class="input last_name" value="<?php if ( isset($_POST['last_name']) ) echo esc_attr($_POST['last_name']); ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "first_name": ?>
...
<tr>
<th><label for="first_name"><?php _e('First name', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["register_first_name_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['first_name'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="first_name" id="first_name" class="input first_name" value="<?php if ( isset($_POST['first_name']) ) echo esc_attr($_POST['first_name']); ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "nickname": ?>
...
<tr>
<th><label for="nickname"><?php _e('Nickname', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["register_nickname_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['nickname'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="nickname" id="nickname" class="input nickname" value="<?php if ( isset($_POST['nickname']) ) echo esc_attr($_POST['nickname']); ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "user_email": ?>
...
<tr>
<th><label for="user_email"><?php _e('E-mail', 'frontend-user-admin') ?></label> <span class="required"><?php echo $required; ?></span></th>
<td<?php if( !empty($this->errors->errors['email_exists'][0]) || !empty($this->errors->errors['empty_email'][0]) || !empty($this->errors->errors['invalid_email'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="user_email" id="<?php if ( !empty($options['global_settings']['email_as_userlogin']) ) echo 'user_login'; else echo 'user_email'; ?>" class="input user_email" value="<?php if ( isset($_POST['user_email']) ) echo esc_attr($_POST['user_email']); ?>" size="25"<?php if ( !empty($options['global_settings']['email_confirmation_first']) ) echo ' readonly="readonly"'; ?> /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "user_url": ?>
...
<tr>
<th><label for="user_url"><?php _e('Website', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["register_user_url_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['user_url'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="user_url" id="user_url" class="input user_url" value="<?php if ( isset($_POST['user_url']) ) echo esc_attr($_POST['user_url']); ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "aim": ?>
...
<tr>
<th><label for="aim"><?php _e('AIM', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["register_aim_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['aim'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="aim" id="aim" class="input aim" value="<?php if ( isset($_POST['aim']) ) echo esc_attr($_POST['aim']); ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "yim": ?>
...
<tr>
<th><label for="yim"><?php _e('Yahoo IM', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["register_yim_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['yim'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="yim" id="yim" class="input yim" value="<?php if ( isset($_POST['yim']) ) echo esc_attr($_POST['yim']); ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "jabber": ?>
...
<tr>
<th><label for="jabber"><?php _e('Jabber / Google Talk', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["register_jabber_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['jabber'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="jabber" id="jabber" class="input jabber" value="<?php if ( isset($_POST['jabber']) ) echo esc_attr($_POST['jabber']); ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "description": ?>
...
<tr>
<th><label for="description"><?php _e('Biographical Info', 'frontend-user-admin'); ?></label><?php if ( !empty($options['global_settings']["register_description_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['description'][0]) ) echo ' class="error_attribute"'; ?>><textarea name="description" id="description" class="textarea description" rows="5" cols="30"><?php if ( isset($_POST['description']) ) echo esc_attr($_POST['description']) ?></textarea><br /><?php _e('Share a little biographical information to fill out your profile. This may be shown publicly.', 'frontend-user-admin'); ?></td></tr>
<?php endif; ?>
<?php		break;
			case "role":
			break;
...
?>
<tr>
<th><label for="pass1"><?php _e('Password', 'frontend-user-admin'); ?></label> <span class="required"><?php echo $required; ?></span></th>
<td<?php if( !empty($this->errors->errors['pass'][0]) ) echo ' class="error_attribute"'; ?>>
...
<?php _e('Hint: Use upper and lower case characters, numbers and symbols like !"?$%^&amp;( in your password.', 'frontend-user-admin'); ?></td>
</tr>
<?php endif; ?>
<?php endif; ?>
<?php endif; ?>
				...
				for($i=0;$i<$count_user_attribute;$i++) :
					if($options['user_attribute']['user_attribute'][$i]['name'] == $val && !empty($options['global_settings']["register_".$options['user_attribute']['user_attribute'][$i]['name']]) && empty($options['user_attribute']['user_attribute'][$i]['admin']) ) :
						...
						elseif ( $options['user_attribute']['user_attribute'][$i]['type']=='hidden' ) :
							$hidden .= '<input type="hidden" name="'.esc_attr($options['user_attribute']['user_attribute'][$i]['name']).'" id="'.esc_attr($options['user_attribute']['user_attribute'][$i]['name']).'" value="'.esc_attr($options['user_attribute']['user_attribute'][$i]['default']).'" />'."\n";
						else : ?>
<tr>
<th><label for="<?php echo $val; ?>"><?php echo $options['user_attribute']['user_attribute'][$i]['label']; ?></label><?php if($options['user_attribute']['user_attribute'][$i]['required']) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors[$options['user_attribute']['user_attribute'][$i]['name']][0]) ) echo ' class="error_attribute"'; ?>>
...
<tr>
<th><label for="terms_of_use"><?php _e('Terms of use', 'frontend-user-admin') ?></label><?php echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['terms_of_use'][0]) ) echo ' class="error_attribute"'; ?>><input type="checkbox" name="terms_of_use" id="terms_of_use" value="1" <?php if ( !empty($_POST['terms_of_use']) ) checked(1); ?> /> 
