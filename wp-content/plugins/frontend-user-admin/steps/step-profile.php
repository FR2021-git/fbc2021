...
<td<?php if( !empty($this->errors->errors['user_login'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="user_login" id="user_login" class="input frontend-user-admin-user_login" value="<?php echo $profileuser->user_login; ?>" disabled="disabled" /><br /><?php _e('Your username cannot be changed', 'frontend-user-admin'); ?></td>
</tr>
<?php endif; ?>
<?php		break;
			case "last_name": ?>
...
<tr>
<th><label for="last_name"><?php _e('Last name', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["profile_last_name_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['last_name'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="last_name" id="last_name" class="input frontend-user-admin-last_name" value="<?php echo $profileuser->last_name ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "first_name": ?>
...
<tr>
<th><label for="first_name"><?php _e('First name', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["profile_first_name_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['first_name'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="first_name" id="first_name" class="input frontend-user-admin-first_name" value="<?php echo $profileuser->first_name ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "nickname": ?>
...
<tr>
<th><label for="nickname"><?php _e('Nickname', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["profile_nickname_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['nickname'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="nickname" id="nickname" class="input frontend-user-admin-nickname" value="<?php echo $profileuser->nickname ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "display_name": ?>
...
<tr>
<th><label for="display_name"><?php _e('Display name publicly&nbsp;as', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["profile_display_name_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['display_name'][0]) ) echo ' class="error_attribute"'; ?>>
<select name="display_name" id="display_name" class="select frontend-user-admin-display_name">
<?php
...
<td<?php if( !empty($this->errors->errors['email_exists'][0]) || !empty($this->errors->errors['empty_email'][0]) || !empty($this->errors->errors['invalid_email'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="user_email" id="<?php if ( !empty($options['global_settings']['email_as_userlogin']) ) echo 'user_login'; else echo 'user_email'; ?>" class="input user_email frontend-user-admin-user_email" value="<?php echo $profileuser->user_email ?>" />
...
<tr>
<th><label for="user_url"><?php _e('Website', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["profile_user_url_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['user_url'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="user_url" id="user_url" class="input user-url frontend-user-admin-user_url" value="<?php echo $profileuser->user_url ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "aim": ?>
...
<tr>
<th><label for="aim"><?php _e('AIM', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["profile_aim_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['aim'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="aim" id="aim" class="input frontend-user-admin-aim" value="<?php echo $profileuser->aim ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "yim": ?>
...
<tr>
<th><label for="yim"><?php _e('Yahoo IM', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["profile_yim_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['yim'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="yim" id="yim" class="input frontend-user-admin-yim" value="<?php echo $profileuser->yim ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "jabber": ?>
...
<tr>
<th><label for="jabber"><?php _e('Jabber / Google Talk', 'frontend-user-admin') ?></label><?php if ( !empty($options['global_settings']["profile_jabber_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['jabber'][0]) ) echo ' class="error_attribute"'; ?>><input type="text" name="jabber" id="jabber" class="input frontend-user-admin-jabber" value="<?php echo $profileuser->jabber ?>" /></td>
</tr>
<?php endif; ?>
<?php		break;
			case "description": ?>
...
<tr>
<th><label for="description"><?php _e('Biographical Info', 'frontend-user-admin'); ?></label><?php if ( !empty($options['global_settings']["profile_description_required"]) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
<td<?php if( !empty($this->errors->errors['description'][0]) ) echo ' class="error_attribute"'; ?>><textarea name="description" id="description" class="textarea frontend-user-admin-description" rows="5" cols="30"><?php echo $profileuser->description ?></textarea><br /><?php _e('Share a little biographical information to fill out your profile. This may be shown publicly.', 'frontend-user-admin'); ?></td>
</tr>
<?php endif; ?>
<?php		break;
			case "role":
...
<td<?php if( !empty($this->errors->errors['pass'][0]) ) echo ' class="error_attribute"'; ?>><input type="password" autocomplete="off" name="pass1" id="pass1" class="input frontend-user-admin-pass1" size="16" value="" /><br /><?php _e("If you would like to change the password type a new one. Otherwise leave this blank.", 'frontend-user-admin'); ?><br />
<input type="password" autocomplete="off" name="pass2" id="pass2" class="input frontend-user-admin-pass2" size="16" value="" /><br /><?php _e("Type your new password again.", 'frontend-user-admin'); ?></td>
</tr>
...
<tr>
<th><label for="<?php echo $val; ?>"><?php echo $options['user_attribute']['user_attribute'][$i]['label']; ?></label><?php if( !empty($options['user_attribute']['user_attribute'][$i]['required']) ) echo ' <span class="required">'.$required.'</span>'; ?></th>
...
<?php					break;      
						case 'checkbox':
							preg_match_all('/"[^"]*"d?|\'[^\']*\'d?/', $options['user_attribute']['user_attribute'][$i]['default'], $matches);
										?>
<?php
							if( isset($profileuser->{$val}) && !is_array($profileuser->{$val}) ) $profileuser->{$val} = maybe_unserialize($profileuser->{$val});
...
<label><input type="radio" name="<?php echo $val; ?>" class="radio <?php echo $val; ?>" value="<?php if ( isset($value) ) echo esc_attr($value); ?>"<?php if( (isset($profileuser->{$val}) && $value == $profileuser->{$val}) || isset($default) ) echo ' checked="checked"';?><?php echo $disabled; ?> /> <?php echo $label; ?></label> 
<?php						endforeach; ?>
<?php					break;
						case 'datetime':
...
<?php
					...
					if( !empty($options['user_attribute']['user_attribute'][$i]['comment']) ) echo '<br /><span class="frontend-user-admin-user-attribute-comment">'.$options['user_attribute']['user_attribute'][$i]['comment'].'</span>';
?></td>
</tr>
<?php
					endif;
