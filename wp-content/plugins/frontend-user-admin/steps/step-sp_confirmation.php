...
<?php
	if( !empty($options['global_settings']['default_messages']) )
		$this->login_header('<div class="message">' . __('Register For This Site', 'frontend-user-admin') . '</div>', $this->errors);
?>
...
<dt><label for="ms_domain"><?php _e('Site Domain', 'frontend-user-admin') ?></label></dt>
<dd><input type="hidden" name="ms_domain" value="<?php echo esc_attr($_POST['ms_domain']); ?>" /><?php echo esc_attr($_POST['ms_domain']); ?></dd>
<?php endif; ?>
<?php		break;
			case "ms_title": ?>
<?php if( is_multisite() && !empty($options['global_settings']['register_ms_title']) ) : ?>
<dt><label for="ms_title"><?php _e('Site Title', 'frontend-user-admin') ?></label></dt>
<dd><input type="hidden" name="ms_title" value="<?php echo esc_attr($_POST['ms_title']); ?>" /><?php echo esc_attr($_POST['ms_title']); ?></dd>
<?php endif; ?>
<?php		break;
			case "user_login": ?>
<?php if( empty($options['global_settings']['email_as_userlogin']) && !empty($options['global_settings']["register_user_login"]) ) : ?>
<dt><label for="user_login"><?php _e('Username', 'frontend-user-admin') ?></label></dt>
<dd><input type="hidden" name="user_login" value="<?php echo esc_attr($_POST['user_login']); ?>" /><?php echo esc_attr($_POST['user_login']); ?></dd>
<?php endif; ?>
<?php		break;
			case "last_name": ?>
<?php if( !empty($options['global_settings']["register_last_name"]) ) : ?>
<dt><label for="last_name"><?php _e('Last name', 'frontend-user-admin') ?></label></dt>
<dd><input type="hidden" name="last_name" value="<?php echo esc_attr($_POST['last_name']); ?>" /><?php echo esc_attr($_POST['last_name']); ?></dd>
<?php endif; ?>
<?php		break;
			case "first_name": ?>
<?php if( !empty($options['global_settings']["register_first_name"]) ) : ?>
<dt><label for="first_name"><?php _e('First name', 'frontend-user-admin') ?></label></dt>
<dd><input type="hidden" name="first_name" value="<?php echo esc_attr($_POST['first_name']); ?>" /><?php echo esc_attr($_POST['first_name']); ?></dd>
<?php endif; ?>
<?php		break;
			case "nickname": ?>
<?php if( !empty($options['global_settings']["register_nickname"]) ) : ?>
<dt><label for="nickname"><?php _e('Nickname', 'frontend-user-admin') ?></label></dt>
<dd><input type="hidden" name="nickname" value="<?php echo esc_attr($_POST['nickname']); ?>" /><?php echo esc_attr($_POST['nickname']); ?></dd>
<?php endif; ?>
<?php		break;
			case "user_email": ?>
<?php if( !empty($options['global_settings']["register_user_email"]) ) : ?>
<dt><label for="user_email"><?php _e('E-mail', 'frontend-user-admin') ?></label></dt>
<dd><input type="hidden" name="user_email" value="<?php echo esc_attr($_POST['user_email']); ?>" /><?php echo esc_attr($_POST['user_email']); ?></dd>
<?php endif; ?>
<?php		break;
			case "user_url": ?>
<?php if( !empty($options['global_settings']["register_user_url"]) ) : ?>
<dt><label for="user_url"><?php _e('Website', 'frontend-user-admin') ?></label></dt>
<dd><input type="hidden" name="user_url" value="<?php echo esc_attr($_POST['user_url']); ?>" /><?php echo esc_attr($_POST['user_url']); ?></dd>
<?php endif; ?>
<?php		break;
			case "aim": ?>
<?php if( !empty($options['global_settings']["register_aim"]) ) : ?>
<dt><label for="aim"><?php _e('AIM', 'frontend-user-admin') ?></label></dt>
<dd><input type="hidden" name="aim" value="<?php echo esc_attr($_POST['aim']); ?>" /><?php echo esc_attr($_POST['aim']); ?></dd>
<?php endif; ?>
<?php		break;
			case "yim": ?>
<?php if( !empty($options['global_settings']["register_yim"]) ) : ?>
<dt><label for="yim"><?php _e('Yahoo IM', 'frontend-user-admin') ?></label></dt>
<dd><input type="hidden" name="yim" value="<?php echo esc_attr($_POST['yim']); ?>" /><?php echo esc_attr($_POST['yim']); ?></dd>
<?php endif; ?>
<?php		break;
			case "jabber": ?>
<?php if( !empty($options['global_settings']["register_jabber"]) ) : ?>
<dt><label for="jabber"><?php _e('Jabber / Google Talk', 'frontend-user-admin') ?></label></dt>
<dd><input type="hidden" name="jabber" value="<?php echo esc_attr($_POST['jabber']); ?>" /><?php echo esc_attr($_POST['jabber']); ?></dd>
<?php endif; ?>
<?php		break;
			case "description": ?>
<?php if( !empty($options['global_settings']["register_description"]) ) : ?>
<dt><label for="description"><?php _e('Biographical Info', 'frontend-user-admin'); ?></label></dt>
<dd><input type="hidden" name="description" value="<?php echo esc_attr($_POST['description']); ?>" /><?php echo esc_attr($_POST['description']); ?></dd>
<?php endif; ?>
<?php		break;
			case "role":
			break;
...
?>
<dt><label for="pass1"><?php _e('Password', 'frontend-user-admin'); ?></label></dt>
<dd><input type="hidden" name="pass1" value="<?php echo esc_attr($_POST['pass1']); ?>" />
<input type="hidden" name="pass2" value="<?php echo esc_attr($_POST['pass2']); ?>" /><?php echo preg_replace('/./','*',$_POST['pass1']); ?></dd>
<?php endif; ?>
<?php endif; ?>
<?php		break;
			default:
...
<dt><label for="<?php echo $val; ?>"><?php echo $options['user_attribute']['user_attribute'][$i]['label']; ?></label></dt>
<dd>
<?php
