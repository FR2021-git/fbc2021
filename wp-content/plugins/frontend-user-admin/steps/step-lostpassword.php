...
<input type="text" name="<?php echo $options['user_attribute']['user_attribute'][$i]['name']; ?>" id="<?php echo $options['user_attribute']['user_attribute'][$i]['name']; ?>" value="<?php if($_POST[$options['user_attribute']['user_attribute'][$i]['name']]) : echo esc_attr($_POST[$options['user_attribute']['user_attribute'][$i]['name']]); else : echo esc_attr($options['user_attribute']['user_attribute'][$i]['default']); endif; ?>" class="input <?php echo $options['user_attribute']['user_attribute'][$i]['name']; ?>" /> 
 <?php if($options['user_attribute']['user_attribute'][$i]['comment']) echo '<br /><span class="frontend-user-admin-user-attribute-comment">'.esc_attr($options['user_attribute']['user_attribute'][$i]['comment']).'</span>';
 				break;
				case 'textarea': ?>
<textarea name="<?php echo esc_attr($options['user_attribute']['user_attribute'][$i]['name']); ?>" id="<?php echo $options['user_attribute']['user_attribute'][$i]['name']; ?>" class="textarea <?php echo $options['user_attribute']['user_attribute'][$i]['name']; ?>"><?php if($_POST[$options['user_attribute']['user_attribute'][$i]['name']]) : echo $_POST[$options['user_attribute']['user_attribute'][$i]['name']]; else : echo esc_attr(stripcslashes($options['user_attribute']['user_attribute'][$i]['default'])); endif; ?></textarea>
 <?php if($options['user_attribute']['user_attribute'][$i]['comment']) echo '<br /><span class="frontend-user-admin-user-attribute-comment">'.esc_attr($options['user_attribute']['user_attribute'][$i]['comment']).'</span>'; ?>
<?php			break;
				case 'select':
...
<option value="<?php echo esc_attr($value); ?>"<?php if($value == $_POST[$options['user_attribute']['user_attribute'][$i]['name']] || $default) echo ' selected="selected"'; ?>><?php echo $label; ?></option>
<?php				endforeach; ?>
</select>
...
<input type="checkbox" name="<?php echo $options['user_attribute']['user_attribute'][$i]['name']; ?>[]" class="checkbox <?php echo $options['user_attribute']['user_attribute'][$i]['name']; ?>" value="<?php echo esc_attr($value); ?>"<?php if((is_array($_POST[$options['user_attribute']['user_attribute'][$i]['name']]) && in_array($value, $_POST[$options['user_attribute']['user_attribute'][$i]['name']])) || $default) echo ' checked="checked"';?> /> <?php echo $label; ?> 
<?php				endforeach; ?>
 <?php if( !empty($options['user_attribute']['user_attribute'][$i]['comment']) ) echo '<br /><span class="frontend-user-admin-user-attribute-comment">'.esc_attr($options['user_attribute']['user_attribute'][$i]['comment']).'</span>'; ?>
<?php			break;                                                                          
				case 'radio':
...
<input type="radio" name="<?php echo $options['user_attribute']['user_attribute'][$i]['name']; ?>" class="radio <?php echo $options['user_attribute']['user_attribute'][$i]['name']; ?>" value="<?php echo esc_attr($value); ?>"<?php if($value == $_POST[$options['user_attribute']['user_attribute'][$i]['name']] || $default) echo ' checked="checked"';?> /> <?php echo $label; ?> 
<?php				endforeach; ?>
 <?php if( !empty($options['user_attribute']['user_attribute'][$i]['comment']) ) echo '<br /><span class="frontend-user-admin-user-attribute-comment">'.esc_attr($options['user_attribute']['user_attribute'][$i]['comment']).'</span>'; ?>
<?php			break;
				case 'datetime':
					...
					if( !empty($options['user_attribute']['user_attribute'][$i]['default']) ) :
						...
						if( !empty($options['user_attribute']['user_attribute'][$i]['comment']) ) echo '<br /><span class="frontend-user-admin-user-attribute-comment">'.esc_attr(stripcslashes($options['user_attribute']['user_attribute'][$i]['comment'])).'</span>';
					endif;
				break;                                                                        
			endswitch;
?></dd><?php
