...
<form name="withdrawalform" id="withdrawalform" action="<?php if ( !empty($options['global_settings']['login_url']) ) echo $this->return_frontend_user_admin_login_url(); ?>action=withdrawal" method="post">
